    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div>
                    <h6 class="m-0 d-inline font-weight-bold text-primary">Edit Postingan</h6>
                </div>
            ...
            <div class="card-body">
                <form action="{{ url("/post-page/$post->id") }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    <div class="form-group row">
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <div id='img_container'>
                                <img id="preview" src="{{ asset("storage/$post->image") }}" alt="your image" title=''/>
                            </div> 
                            <div class=""> 
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 mb-3 mb-sm-0">
                            ...
                            <textarea class="form-control" name="description" id="konten" cols="30" rows="10" required>{{ $post->description }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-12 mb-3 mb-sm-0">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3 mb-3 mb-sm-0">
                            ...
                            <input type="date" class="form-control" name="publish" required value="{{ $post->publish }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-12 mb-3 mb-sm-0">
