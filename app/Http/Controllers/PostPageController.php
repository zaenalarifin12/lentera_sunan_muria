...
class PostPageController extends Controller
{
    ...
    public function create()
    {
        ...
        return view("post-page.create", compact("categories", "writers"));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect("/post-page")->with("msg", "post berhasil ditambahkan");
    }
    ...
    public function edit($id)
    {
        ...
        return view("post-page.edit", compact("post", "categories", "writers"));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect("/post-page")->with("msg", "post berhasil diperbarui");
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect("/post-page")->with("msg", "post berhasil dihapus");
    }
}
